...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>SMSMonitor Application</title>
    ...
    <body>
        <div id="wrapper">
            <div id="navigation" class="curved container">
                <span id="nav-home"><a href="/SMSMonitor/login/login.jsf">Home</a></span>
                <span id="nav-help"><a href="#">Find Help</a></span>
                <br class="separator" />
            </div>
            <div id="asf-box">
                <h1>App V 1.1</h1>
            ...
            <div id="upper" class="curved container">
                <div id="congrats" class="curved container">
                    <h2>If you're seeing this, you've successfully landed/reached the application. Congratulations!</h2>
                </div>
                <div id="notice">
                    <img src="logo.png" alt="[bbyn logo]" />
                    <div id="tasks">
                        <h3>Recommended Reading:</h3>
                        <h4><a href="/SMSMonitor/login/login">Application</a></h4>
                        <h4><a href="/SMS_Service/json/product/postSMS">Service</a></h4>
                    </div>
                </div>
                <div id="actions">
                    <div class="button">
                        <a class="container shadow" href="/SMSMonitor/login/login"><span>Application</span></a>
                    </div>
                    <div class="button">
                        <a class="container shadow" href="/SMS_Service/json/product/postSMS"><span>Service</span></a>
                    </div>
                </div>
                <br class="separator" />
            </div>
           ...
           <!-- <div id="lower">
            ...
            <p class="copyright">Copyright &copy;1999-${year} Boubyan Bank.  All Rights Reserved</p>
        </div>
    </body>
